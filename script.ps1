...
if ($isNugget -eq "YES") {
    ...
    CreateJson-Craft $pathCraftFile "NUGGET_DEFAULT" $defaultOreCraft $nameL
}
...
if ($isBlock -eq "YES")
{
    ...
    CreateJson-Craft $pathCraftFile "BLOCK_DEFAULT" $defaultOreCraft $nameL
...
if ($isTool -eq "YES")
{
    ...
    if ($isCraftToolDef -eq "NO")
    {
        ...
        {
            CreateJson-Craft $pathCraftFile "TOOL_MERCURE" $defaultOreCraft $nameL
        }
...
if ($isArmor -eq "YES"){
    ...
    if ($isCraftArmorDef -eq "YES")
    {
        CreateJson-Craft $pathCraftFile "ARMOR_DEFAULT" $defaultOreCraft $nameL
    }
    if ($isCraftArmorDef -eq "NO")
    {

        echo "What Class of Armor? | default: 1"
        echo " 1 = ..."
        echo " 2 = ..."
        echo " etc..."
        $isCraftToolClass = Read-Host "Reponse "
